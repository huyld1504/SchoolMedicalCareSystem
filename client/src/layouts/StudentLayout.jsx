    ...
    <div className="student-layout">
      ...
      <div className="sidebar bg-warning">
        <div className="logo p-4 text-center border-bottom">
          ...
          >
            <i className="bi bi-capsule me-2"></i> Thuốc của em
          </a>
          <a
            className="nav-link d-flex align-items-center py-2"
            href="/student/vaccinations"
          >
            <i className="bi bi-shield-plus me-2"></i> Tiêm chủng của em
          </a>
          <a
            className="nav-link d-flex align-items-center py-2"
      ...
      <div className="main-content">        <header className="bg-white shadow-sm p-3">
        <div className="d-flex justify-content-between align-items-center">
          <div>
            <h2 className="mb-0">Cổng thông tin Sức khỏe Học sinh</h2>
          </div>
