...
function MagnusDoctors() {
  const doctors = [
    {
      id: 1,
      name: 'BS. Michael Nguyen',
      specialty: 'Bác sĩ Nhi khoa',
      bio: 'BS. Michael có hơn 15 năm kinh nghiệm trong lĩnh vực nhi khoa và chăm sóc sức khỏe học đường.',
    ...
    },
    {
      ...
      bio: 'BS. Hannah chuyên về các vấn đề sức khỏe tổng quát và tư vấn dinh dưỡng cho học sinh.',
    ...
    },
    {
      ...
      bio: 'BS. Thomas là chuyên gia tâm lý học đường, hỗ trợ học sinh với các vấn đề tâm lý và phát triển.',
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        <div className="section-header text-center" style={{ marginBottom: '60px' }}>          <span style={{
          ...
          <p style={{
            ...
            margin: '0 auto',
            lineHeight: '1.7'
          }}>Các chuyên gia y tế tận tâm trong đội ngũ của chúng tôi</p>
        </div>
