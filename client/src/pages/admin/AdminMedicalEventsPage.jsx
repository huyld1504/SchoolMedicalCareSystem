...
const AdminMedicalEventsPage = () => {
    ...
    }, [query.page, query.limit, query.keyword, query.eventType, query.level, query.dateFrom, query.dateTo, query.status]); const loadMedicalEvents = async () => {
        try {
            setLoading(true);
    ...
    const handleAddEvent = () => {
        navigate('/admin/medical-events/add');
        ...
        navigate(`/admin/medical-events/edit/${eventId}`, {
            state: {
                eventData: selectedEvent,
                from: '/admin/medical-events'
            }
        });
        ...
        navigate(`/admin/medical-events/detail/${eventId}`, {
