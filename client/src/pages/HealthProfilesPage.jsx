...
const HealthProfilesPage = () => {
    ...
    useEffect(() => {
        loadHealthProfiles();
    }, [studentId, page, rowsPerPage, searchTerm]);
                                                        ...
                                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                                            ...
                                                            <Box>
                                                                ...
                                                                <Typography variant="body2" color="text.secondary">
                                                                    Mã HS: {profile.student?.studentCode}
                                                                </Typography>
                                                            </Box>
                                                        </Box>
                                                    </Grid>
                                                        ...
                                                        <Grid container spacing={2}>
                                                            <Grid item xs={6}>
                                                                ...
                                                                <Typography variant="body1">
                                                                    {formatDate(profile.student?.birthdate)}
                                                                </Typography>
                                                            </Grid>
                                                            <Grid item xs={6}>
                                                                <Typography variant="caption" color="text.secondary">
                                        ...
                                        <Card sx={{ height: '100%' }}>
                                            <CardContent>
                                                ...
                                                <HealthInfoItem
                                                    icon={<AllergyIcon />}
                                                    label="Dị ứng"
                                                    value={profile.allergies || 'Không có'}
                                                    color="#ff9800"
                                                />
                                                <HealthInfoItem
                                                    icon={<DiseaseIcon />}
                                                    label="Bệnh mãn tính"
                                                    value={profile.chronicDiseases || 'Không có'}
                                                    color="#9c27b0"
                                                />
                                                <Box sx={{ mt: 2 }}>
                                                    <Typography variant="caption" color="text.secondary">
